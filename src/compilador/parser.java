...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Dec 05 21:30:09 PYST 2016
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		NodoBase cu = (NodoBase)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
						...
						RESULT = new NodoFor(sd, se, decl); // TODO COMPLETAR NODO
          ...
          case 36: // sent_asig ::= 
            {
              NodoBase RESULT =null;
						...
						RESULT = new NodoAsignacion(var_identificador, null);
		...
		String variable = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
						...
						if(debug) System.out.println("\t Regla 16c");
						RESULT = new NodoAsignacion(var_identificador, new NodoVar(variable, ""), true);
		...
		NodoBase ex = (NodoBase)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
						...
						RESULT = new NodoAsignacion(var_identificador, ex);
		...
		NodoBase de = (NodoBase)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
						...
						RESULT = new NodoAsignacion(var_identificador, de);
		...
		NodoBase de = (NodoBase)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
						...
						NodoBase hijoActual = ld;
					
						if (hijoActual != null) {
							while(hijoActual.TieneHermano()) {
								hijoActual = hijoActual.getHermanoDerecha();
							}
							hijoActual.setHermanoDerecha(de);
							RESULT = ld;
						} else {
							RESULT = de;
						}	
